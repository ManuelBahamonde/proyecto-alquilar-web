...
const Home = () => {
  ...
  const handleSearch = () => {
    ...
    if (filters.localidad && filters.tipoInmueble) {
      navigate(
        `/inmuebles?idLocalidad=${filters.localidad.value}&idTipoInmueble=${filters.tipoInmueble.value}`
      );
    }
      ...
      <div className="home">
        <div className="integrantes">
          <Container className="searchContainer">
            ...
            <br />
            <Row>
              <h5 className="tittle-labels">
                Te ayudamos a encontrar esa propiedad que tanto necesitas
              </h5>
            </Row>
            <br />
            <Row>
